...
/**
 * CartCustomerAddressesFixture
 */
class CartCustomerAddressesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'cart_customer_addresses_ibfk_1' => ['type' => 'foreign', 'columns' => ['cart_id'], 'references' => ['carts', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'country' => 1,
                'created' => '2020-01-05 20:43:27',
                'modified' => '2020-01-05 20:43:27',
            ],
        ];
        parent::init();
    }
